...
const EditEvent: React.FC = () => {
  ...
  const [initialValues, setInitialValues] = useState<EditEventFormValues>({
    title: '',
    description: '',
    date: '',
    location: '',
  ...
  useEffect(() => {
    if (currentEvent) {
      setInitialValues({
        ...
        totalTickets: currentEvent.totalTickets.toString(),
        imageUrl: currentEvent.imageUrl,
      });
    }
  }, [currentEvent]);

  const handleSubmit = async (values: EditEventFormValues, { setSubmitting }: { setSubmitting: (isSubmitting: boolean) => void }) => {
    try {
      if (id) {
